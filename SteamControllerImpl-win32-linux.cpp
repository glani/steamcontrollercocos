...
public:
	...
	bool processEvents(uint8_t total_read, SteamControllerEvent** events, SteamControllerDevice* pDevice, SteamController* steamController)
	{
	...
	void onUpdate(SteamControllerDevice * pDevice, SteamController *pController, const SteamControllerEvent &event) {
		...
		v.ButtonA = (uint8_t)((event.update.buttons & STEAMCONTROLLER_BUTTON_A) > 0 ? SteamControllerValues::YES : SteamControllerValues::NO);
		v.ButtonX = (uint8_t)((event.update.buttons & STEAMCONTROLLER_BUTTON_X) > 0 ? SteamControllerValues::YES : SteamControllerValues::NO);
		v.ButtonB = (uint8_t)((event.update.buttons & STEAMCONTROLLER_BUTTON_B) > 0 ? SteamControllerValues::YES : SteamControllerValues::NO);
		v.ButtonY = (uint8_t)((event.update.buttons & STEAMCONTROLLER_BUTTON_Y) > 0 ? SteamControllerValues::YES : SteamControllerValues::NO);
		v.ButtonRT = (uint8_t)((event.update.buttons & STEAMCONTROLLER_BUTTON_RT) > 0 ? SteamControllerValues::YES : SteamControllerValues::NO);
		v.ButtonLT = (uint8_t)((event.update.buttons & STEAMCONTROLLER_BUTTON_LT) > 0 ? SteamControllerValues::YES : SteamControllerValues::NO);
		v.ButtonRS = (uint8_t)((event.update.buttons & STEAMCONTROLLER_BUTTON_RS) > 0 ? SteamControllerValues::YES : SteamControllerValues::NO);
		v.ButtonLS = (uint8_t)((event.update.buttons & STEAMCONTROLLER_BUTTON_LS) > 0 ? SteamControllerValues::YES : SteamControllerValues::NO);

		v.ButtonDpadUp = (uint8_t)((event.update.buttons & STEAMCONTROLLER_BUTTON_DPAD_UP) > 0 ? SteamControllerValues::YES : SteamControllerValues::NO);
		v.ButtonDpadRight = (uint8_t)((event.update.buttons & STEAMCONTROLLER_BUTTON_DPAD_RIGHT) > 0 ? SteamControllerValues::YES : SteamControllerValues::NO);
		v.ButtonDpadLeft = (uint8_t)((event.update.buttons & STEAMCONTROLLER_BUTTON_DPAD_LEFT) > 0 ? SteamControllerValues::YES : SteamControllerValues::NO);
		v.ButtonDpadDown = (uint8_t)((event.update.buttons & STEAMCONTROLLER_BUTTON_DPAD_DOWN) > 0 ? SteamControllerValues::YES : SteamControllerValues::NO);

		v.ButtonPrev = (uint8_t)((event.update.buttons & STEAMCONTROLLER_BUTTON_PREV) > 0 ? SteamControllerValues::YES : SteamControllerValues::NO);
		v.ButtonHome = (uint8_t)((event.update.buttons & STEAMCONTROLLER_BUTTON_HOME) > 0 ? SteamControllerValues::YES : SteamControllerValues::NO);
		v.ButtonNext = (uint8_t)((event.update.buttons & STEAMCONTROLLER_BUTTON_NEXT) > 0 ? SteamControllerValues::YES : SteamControllerValues::NO);

		v.ButtonRGrip = (uint8_t)((event.update.buttons & STEAMCONTROLLER_BUTTON_LG) > 0 ? SteamControllerValues::YES : SteamControllerValues::NO);
		v.ButtonLGrip = (uint8_t)((event.update.buttons & STEAMCONTROLLER_BUTTON_RG) > 0 ? SteamControllerValues::YES : SteamControllerValues::NO);

		v.ButtonStick = (uint8_t)((event.update.buttons & STEAMCONTROLLER_BUTTON_STICK) > 0 ? SteamControllerValues::YES : SteamControllerValues::NO);
		v.ButtonRPad = (uint8_t)((event.update.buttons & STEAMCONTROLLER_BUTTON_RPAD) > 0 ? SteamControllerValues::YES : SteamControllerValues::NO);
